...
```
You can check the [Counter](https://praveenoruganti.github.io/praveenoruganti-javascript/7_Document%20Object%20Model(DOM)/2_Update%20HTML%20Content_Attributes_Styles) for reference.
...
```
You can check out this [color flipper](https://praveenoruganti.github.io/praveenoruganti-javascript/7_Document%20Object%20Model(DOM)/3_Events/1_Intro%20to%20Events) based on button click event.
...
```
Also refer the [page](https://praveenoruganti.github.io/praveenoruganti-javascript/7_Document%20Object%20Model(DOM)/3_Events/2_Form%20Events) and see the browser console.
...
Also refer the [page](https://praveenoruganti.github.io/praveenoruganti-javascript/7_Document%20Object%20Model(DOM)/3_Events/3_Keyboard%20Events)

You can also refer the [JavaScript Drum Kit](https://praveenoruganti.github.io/praveenoruganti-javascript/0_Projects/praveenoruganti-modal)
